...
def index():
    if request.method == 'POST':
        try:
            ...
            fertilizer_prediction_num = rf_model.predict(fertilizer_features)[0]
            fertilizer_name = fertilizer_dict.get(fertilizer_prediction_num, "Unknown Fertilizer")
